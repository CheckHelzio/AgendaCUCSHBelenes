...
import checkhelzio.ccv.agendacucshbelenes.util.DescargarData;
import checkhelzio.ccv.agendacucshbelenes.util.LlenarListaEventos;
...
public class Inicio extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Object> {
    ...
    protected static boolean filtro1 = true, filtro2 = true, filtro3 = true, filtro4 = true, filtro5 = true, filtro6 = true;
    ...
    private void iniciarObjetos() {
        ...
        fab.setOnClickListener(view -> {
            Intent intent = new Intent(Inicio.this, RegistrarEventoB.class);
        ...
        tv_header2 = findViewById(R.id.tv_header);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_buscar:
                ...
                String conceptos = prefs.getString(getString(R.string.prefs_titulos), "" +
                        prefs.getString(getString(R.string.prefs_nombres_solicitante), "") +
                        prefs.getString(getString(R.string.prefs_tipos_evento), "") + "¦" +
                        prefs.getString(getString(R.string.prefs_nombres_dependencias), "") + "¦" +
                        prefs.getString(getString(R.string.prefs_nombres_responsables), "") + "¦" +
                        auditorio1 + "¦" + auditorio2 + "¦" + auditorio3 + "¦" + auditorio4 + "¦" + auditorio5 + "¦" + auditorio6 + "¦");
    ...
    private Eventos agregarEvento(String eventos_suelto) {
        return new Eventos(
                ...
                eventos_suelto.trim(),
                // FONDO
                Data.getFondoAuditorio(eventos_suelto.split("::")[4].trim(), eventos_suelto.split("::")[13].trim(), eventos_suelto.split("::")[3].trim(), getApplicationContext()),
                // CLASE
        ...
        protected void onProgressUpdate(Object... values) {
            ...
            try {
                if (eventos.length > 1 || (eventos.length == 1 && !eventos[0].equals(""))) {
                    ...
                    lista_info1[x - 1 + diasemana].setText(Data.getNombreAula(eventos[0].split("::")[17].trim()));
                    ...
                    if (eventos.length >= 2) {
                        ...
                        lista_info2[x - 1 + diasemana].setText(Data.getNombreAula(eventos[1].split("::")[17].trim()));
