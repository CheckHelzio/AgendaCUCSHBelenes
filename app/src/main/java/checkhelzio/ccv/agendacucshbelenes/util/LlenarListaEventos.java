...
public class LlenarListaEventos extends AsyncTaskLoader<Object> {
    ...
    private String st_nombresSolicitante;
    private String st_nombresResponsables;
    private String st_nombresDependencias;
    private int id_prox;
    ...
    public LlenarListaEventos(Context context, String data) {
        ...
        st_nombresSolicitante = prefs.getString(context.getString(R.string.prefs_nombres_solicitante), "");
        st_nombresResponsables = prefs.getString(context.getString(R.string.prefs_nombres_responsables), "");
        st_nombresDependencias = prefs.getString(context.getString(R.string.prefs_nombres_dependencias), "");
    ...
    public Object loadInBackground() {
        ...
        stb_nombresOrganizador.append(st_nombresSolicitante);
        StringBuilder stb_nombresResponsables = new StringBuilder();
        stb_nombresResponsables.append(st_nombresResponsables);
        StringBuilder stb_nombresDependencias = new StringBuilder();
        stb_nombresDependencias.append(st_nombresDependencias);
        ...
        try {
            for (String eventos_suelto : st_data.trim().split("¦")) {
                if (!TextUtils.isEmpty(eventos_suelto)) {
                    ...
                    st_nombresSolicitante = stb_nombresOrganizador.toString();
                    ...
                    if (!st_nombresSolicitante.contains(eventos_suelto.trim().split("::")[6].trim())) {
                        stb_nombresOrganizador.append(eventos_suelto.trim().split("::")[6].trim()).append("¦");
                    }
                    if (!st_nombresResponsables.contains(eventos_suelto.trim().split("::")[15].trim())) {
                        stb_nombresResponsables.append(eventos_suelto.trim().split("::")[15].trim()).append("¦");
                    }
                    if (!st_nombresDependencias.contains(eventos_suelto.trim().split("::")[14].trim())) {
                        stb_nombresDependencias.append(eventos_suelto.trim().split("::")[14].trim()).append("¦");
                    }
                    ...
                    Eventos nuevo_evento = new Eventos(
                            ...
                            eventos_suelto.trim(),
                            // FONDO
                            Data.getFondoAuditorio(eventos_suelto.split("::")[4].trim(), eventos_suelto.split("::")[13].trim(), eventos_suelto.split("::")[3].trim(), getContext()),
                            // CLASE
            ...
            prefs.edit().putString(getContext().getString(R.string.prefs_nombres_solicitante), stb_nombresOrganizador.toString()).apply();
            ...
            prefs.edit().putString(getContext().getString(R.string.prefs_nombres_responsables), stb_nombresResponsables.toString()).apply();
            prefs.edit().putString(getContext().getString(R.string.prefs_nombres_dependencias), stb_nombresDependencias.toString()).apply();
