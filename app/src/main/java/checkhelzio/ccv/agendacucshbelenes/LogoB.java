...
public class LogoB extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Object> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        st_update = prefs.getString(getString(R.string.prefs_update), "");
            ...
            default:
                if (data != null) {
                    if (!data.toString().equals(st_update)) {
                        ...
                        Intent i = new Intent(LogoB.this, Inicio.class);
                        startActivity(i);
                        finish();
                    }
                }
